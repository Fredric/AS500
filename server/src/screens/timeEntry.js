...
import { defineScreen, render, header, text, form, field, } from '../dsl/index.js';
import { getDayItem, createDayItem, updateDayItem, isValidTime, getDayName, } from '../services/timeReg.js';
// ============================================
...
// Screen Builder
// ============================================
export function buildTimeEntryScreen(session, message = null, messageType = null) {
    const currentDate = session.context.timeRegDate;
    const editItemId = session.context.editItemId;
...
// Screen Handler
// ============================================
export function handleTimeEntry(session, request) {
