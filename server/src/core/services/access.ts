...
export const PERMISSION_REGISTRY: Array<{ key: PermissionKey; description: string }> = [
  ...
  { key: PERMISSIONS.DOCUMENTS_READ,  description: 'View own documents and folders' },
  { key: PERMISSIONS.DOCUMENTS_WRITE, description: 'Create/edit/delete own documents and folders' },
