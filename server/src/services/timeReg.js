 ...
 */
export function getOrCreateDay(userId, workday) {
 ...
 */
export function updateDaySum(dayId) {
 ...
 */
export function getPreviousDay(userId, currentDate) {
    // Parse as local date to avoid timezone issues
 ...
 */
export function getDayItem(itemId) {
    return db.prepare('SELECT * FROM day_items WHERE id = ?').get(itemId);
}
/**
 * Create a new time entry
 */
export function createDayItem(dayId, startHour, endHour, jiratask, description) {
 ...
 */
export function updateDayItem(itemId, startHour, endHour, jiratask, description) {
 ...
 * Delete a time entry
 */
export function deleteDayItem(itemId) {
    const existing = getDayItem(itemId);
    if (!existing)
        return false;
